...
function Nav() {
  ...
  return (
    <nav className="flex items-center justify-between pt-8">
      ...
      <ul
        className={`bg-darkColor lg:text-right w-full h-full duration-500 ease-linear lg:pl-10 lg:static fixed  top-0 lg:h-auto z-10 ${
      ...
      >
        ...
        <li className="lg:inline-block  lg:ml-10 ml-5 lg:my-0 my-6 border-b-2 border-darkColor hover:border-white duration-300 mr-40">
          <Link
            to="/contact"
            className="text-middleOrange cursor-pointer font-Raleway font-normal text-sm inline-block lg:py-5 py-3"
            onClick={() => setNavOpen(!navOpen)}
